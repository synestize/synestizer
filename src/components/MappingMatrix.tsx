...
const parameterLabels: Record<ParameterName, string> = {
  ...
  melody_filter_freq:    'Melody Filter',
  bass_filter_freq:      'Bass Filter',
  drums_filter_freq:     'Drums Filter',
  melody_reverb:         'Melody Reverb',
  bass_reverb:           'Bass Reverb',
  drums_reverb:          'Drums Reverb',
  melody_delay:          'Melody Delay',
  bass_delay:            'Bass Delay',
  drums_delay:           'Drums Delay',
...
const groups: { label: string; color: string; params: ParameterName[] }[] = [
  ...
  { label: 'FX',      color: '#e879f9', params: ['melody_filter_freq', 'bass_filter_freq', 'drums_filter_freq', 'melody_reverb', 'bass_reverb', 'drums_reverb', 'melody_delay', 'bass_delay', 'drums_delay'] },
