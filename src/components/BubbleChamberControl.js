...
const BubbleChamberControl = ({
  ...
  return (<SubPane className='vert' title='Bubble Chamber'>
    ...
    <SubPane className='vert' title='Voice 1'>
      ...
      <SpecificAudioParam sinkControlKey='bubbleChamber|voice1pattern' />
    ...
    <SubPane className='vert' title='Voice 2'>
      ...
      <SpecificAudioParam sinkControlKey='bubbleChamber|voice2pan' />
      <SpecificAudioParam sinkControlKey='bubbleChamber|voice2pattern' />
    ...
    <SubPane className='vert' title='Bass'>
      ...
      <SpecificAudioParam sinkControlKey='bubbleChamber|basspattern' />
