...
export const TOGGLE_BUBBLE_CHAMBER_BASS_MUTE = 'TOGGLE_BUBBLE_CHAMBER_BASS_MUTE'

export const SET_BUBBLE_CHAMBER_VOICE_1_SAMPLE = 'SET_BUBBLE_CHAMBER_VOICE_1_SAMPLE'
export const SET_BUBBLE_CHAMBER_VOICE_2_SAMPLE = 'SET_BUBBLE_CHAMBER_VOICE_2_SAMPLE'
